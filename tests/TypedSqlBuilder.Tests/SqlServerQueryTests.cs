...
public class SqlServerQueryTests : IQueryTestContract, ISqlServerDialectTestContract
{
    ...
    public Task FromSelectSum_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = scalarQuery.ToSqlServerRaw();
    ...
    public Task AvgPrices_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = avgExpr.ToSqlServerRaw();
    ...
    public Task MinPrice_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = minExpr.ToSqlServerRaw();
    ...
    public Task MaxPrice_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = maxExpr.ToSqlServerRaw();
