...
/// <summary>
/// PostgreSQL-specific tests for INSERT, UPDATE, and DELETE statements using TestStatements
/// </summary>
public class PostgreSqlStatementsTests : IStatementTestContract
{
    [Fact]
    ...
    [Fact]
    public void PostgreSql_UsesColonPrefix()
    {
        // Arrange  
