...
/// <summary>
/// PostgreSQL-specific tests using queries from TestQueries
/// </summary>
public class PostgreSqlQueryTests : IQueryTestContract, IPostgreSqlDialectTestContract
{
    [Fact]
    ...
    [Fact]
    public void StringConcat_UsesOperatorNotFunction()
    {
        // Arrange
    ...
    // Basic Query Tests - continuing from existing ones
    [Fact]
    ...
    {
        // Arrange
        var query = TestQueries.FromWhereSelectParameterized(18, 65);
    ...
    // Additional order by and advanced tests
    [Fact]
    ...
    public Task CountActiveCustomers_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = countExpr.ToPostgreSqlRaw();
    ...
    public Task FromSelectAvg_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = scalarQuery.ToPostgreSqlRaw();
    ...
    public Task SumAges_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = sumExpr.ToPostgreSqlRaw();
    ...
    public Task AvgPrices_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = avgExpr.ToPostgreSqlRaw();
    ...
    public Task MinPrice_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = minExpr.ToPostgreSqlRaw();
    ...
    public Task MaxPrice_GeneratesCorrectSql()
    {
        ...
        // Act
        var (sql, parameters) = maxExpr.ToPostgreSqlRaw();
